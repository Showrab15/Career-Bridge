        ...
        <div className="w-full h-full rounded-md bg-red-50 px-4 py-4">
            <div>
                ...
                <div className="flex mt-2">
                    ...
                    <p style={{ color: "#757575" }} className="mr-4 font-semibold text-lg "> <FontAwesomeIcon icon={faLocationDot} /> {location}</p>

                    <p style={{ color: "#757575" }} className="font-semibold text-lg ml-2">  <FontAwesomeIcon className="ml-2" icon={faDollar} /> {salary}</p>
