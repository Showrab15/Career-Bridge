        ...
        <div>
            ...
            <div className="md:flex md:justify-around md:m-32  gap-48">
                ...
                <div className=" mt-2 md:w-[50%] ml-2 mr-2 md:ml-0 md:mr-0 ">
                    ...
                    </span> : <span style={{ color: '#757575' }}>{job_responsibility

                    }</span> </p>
                    <p className="mt-4 font-bold text-base"><span className=" text-black mb-4">Educational Requirements
                    </span> :  <br /><span style={{ color: '#757575' }}>{educational_requirements

                    }</span> </p>
                    <p className="mt-4 font-bold text-base" ><span className=" text-black mb-4">Experience

                    </span> :  <br /><span style={{ color: '#757575' }}>{experience
